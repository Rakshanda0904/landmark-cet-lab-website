...
const projects = [
  {
    color: "#0a0f16",
    src: "src/assets/pile-integrity-test.png",
  ...
  {
    color: "#0c121b",
    src: "src/assets/dynamic-load-testing.png",
  ...
  {
    color: "#0c121b",
    src: "src/assets/lateral-load-test.png",
  ...
  {
    color: "#0c121b",
    src: "src/assets/bridge-load-test.png",
  ...
  {
    color: "#0f1621",
    src: "src/assets/static-load-test.png",
  ...
  {
    color: "#0f1621",
    src: "src/assets/anchor-pullout-test.png",
  ...
  {
    color: "#111827",
    src: "src/assets/EV2-Load-Test.png",
  ...
  {
    color: "#161e2e",
    src: "src/assets/ndt-test.png",
    title: "NDT testing",
    description: "USPV, R.Hammer, Halfcell, Carbonation, Water",
  },
  {
    color: "#161e2e",
    src: "src/assets/soil-test.png",
    title: "Soil Testing",
  ...
  {
    color: "#161e2e",
    src: "src/assets/spt-test.png",
    title: "SPT Testing",
    description: "Used to determine the relative density, bearing capacity, and settlement of granular soil",
  },
  {
    color: "#161e2e",
    src: "src/assets/permeability-test.png",
    title: "Permeability Test",
    description: "evaluate how well concrete resists water penetration",
  },
  {
    color: "#161e2e",
    src: "src/assets/marshal-stability-test.png",
    title: "Marshal Stability Test",
    description: "Performance prediction measure conducted on the bituminous nix",
  },
  {
    color: "#161e2e",
    src: "src/assets/ductility-test.png",
    title: "Ductility Test",
    description: "Measures the distance in centimetre to which a binder sample could be elongated before breaking at a specific speed and temperature"
  },
  {
    color: "#161e2e",
    src: "src/assets/aggregate-test.png",
  ...
  {
    color: "#161e2e",
    src: "src/assets/cement-test.png",
